...
* **CONTRACT COMPLETENESS**: You MUST create EVERY file listed in your contract's `files_to_modify`, including non-code artifacts — `.gitignore`, `LICENSE`, `README.md`, build manifests — with the literal content the ticket specifies. Do not stop at source code; a missing contracted file is rerouted back to you.
